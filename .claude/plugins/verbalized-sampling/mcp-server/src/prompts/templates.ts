 ...
 */
export function buildVSPrompt(config: PromptConfig, domain: VSGenerateDomain): string {
 ...
 */
function getDomainGuidance(domain: VSGenerateDomain): string {
  switch (domain) {
    case 'architecture':
 ...
 */
export const VS_SYSTEM_PROMPT = `You are an expert at generating diverse, probability-weighted options using Verbalized Sampling.
